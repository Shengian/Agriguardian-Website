...
console.log('5. Copying React platform dist build into dist_site...');
...
if (fs.existsSync(platformDist)) {
  ...
  // Copy React platform index.html to app.html in dist_site
  fs.copyFileSync(path.join(platformDist, 'index.html'), path.join(distSiteDir, 'app.html'));
}

console.log('6. Creating Netlify _redirects file in dist_site...');
...
console.log('✓ Build complete! dist_site ready for Netlify');
