...
export function GlassCard({ children, className = '', delay = 0, style, onClick }: { children: ReactNode; className?: string; delay?: number; style?: React.CSSProperties; onClick?: () => void }) {
  return (
    <motion.div
